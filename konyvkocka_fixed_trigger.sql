...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2026. Jan 14. 09:15
...
INSERT INTO `deleted_user` (`Id`, `Username`, `Email`, `PasswordHash`, `PasswordSalt`, `CountryCode`, `ProfilePic`, `Premium`, `CreationDate`, `LastLoginDate`, `Level`, `BookPoints`, `SeriesPoints`, `MoviePoints`, `DayStreak`, `ReadTimeMin`, `WatchTimeMin`) VALUES
(1, 'asd12', 'asd@gmail.com', 'asd', 'asd', 'as', 'asd.img', 1, '2025-12-12', '2026-01-11', 15, 12000, 10000, 5000, 5, 90, 145);
