# KÖNYVKOCKA — release/v1.0

## Röviden erről az ágról

A v1.0 release branch a rendszer első teljes értékű, éles használatra szánt kiadási változata.

A fókusz a konzisztens működésen, a felhasználói élményen és a stabil deploy-on van.
